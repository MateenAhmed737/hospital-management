  ...
  return (
    <div>
      ...
      <select
        ...
        className={`shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-xs outline-none rounded-lg transition-all duration-300 focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 ${styles}`}
        required={required}
        disabled={disabled}
      >
        {emptySelection && (
